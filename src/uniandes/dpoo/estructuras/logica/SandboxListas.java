...
public class SandboxListas
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        {
            if (listaEnteros.get(i) == valor) // con enteros se puede usar ==
            {
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        {
            if (listaCadenas.get(i).equals(cadena)) // usamos .equals() para comparar cadenas
            {
    ...
    public void organizarEnteros( )
    {
        ...
        do
        {
            ...
            for (int i = 0; i < n - 1; i++)
            {
                if (listaEnteros.get(i) < listaEnteros.get(i + 1))
                {
                    int temp = listaEnteros.get(i);
                    listaEnteros.set(i, listaEnteros.get(i + 1));
                    listaEnteros.set(i + 1, temp);
                    cambiado = true;
                }
            }
            n--;
    ...
    public void organizarCadenas( )
    {
        ...
        do
        {
            ...
            for (int i = 0; i < n - 1; i++)
            {
                if (listaCadenas.get(i).compareTo(listaCadenas.get(i + 1)) > 0)
                {
                    String temp = listaCadenas.get(i);
                    listaCadenas.set(i, listaCadenas.get(i + 1));
                    listaCadenas.set(i + 1, temp);
                    cambiado = true;
                }
            }
            n--; 
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int i = 0; i < listaEnteros.size(); i++)
        {
            ...
            {
                int repeticiones = 0;
                for (int k = i + 1; k < listaEnteros.size(); k++)
                {
                    if (listaEnteros.get(k) == valor)
                    {
                        repeticiones++;
                    }
                }
