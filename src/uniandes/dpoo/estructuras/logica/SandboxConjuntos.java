...
public class SandboxConjuntos
{
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        for (String elem : arbolCadenas) {
            if (elem.compareTo(cadena) >= 0) { // mayor o igual
                resultado.add(elem);
            }
        }
    ...
    {
        Set<String> nuevasCadenas = new TreeSet<>();

        for (String cad : arbolCadenas) {
            nuevasCadenas.add(cad.toUpperCase());
        }

        arbolCadenas.clear();
        arbolCadenas.addAll(nuevasCadenas);
